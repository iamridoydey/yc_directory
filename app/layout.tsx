...
const workSans = localFont({
  src: [
    ...
    { path: "./fonts/WorkSans-ExtraLight.ttf", weight: "600", style: "normal" },
    { path: "./fonts/WorkSans-Light.ttf", weight: "500", style: "normal" },
    { path: "./fonts/WorkSans-Medium.ttf", weight: "400", style: "normal" },
    { path: "./fonts/WorkSans-Regular.ttf", weight: "300", style: "normal" },
    { path: "./fonts/WorkSans-SemiBold.ttf", weight: "200", style: "normal" },
